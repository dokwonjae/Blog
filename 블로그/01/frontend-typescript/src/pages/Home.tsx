      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4" data-aos="fade-right">
            <img src={require("../assets/img/me.jpg")} className="img-fluid" alt=""/>
          </div>
          <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div className="row">
              <div className="col-lg-6">
                <ul>
                  <li><i className="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>18 sep 1997</span></li>
                  <li><i className="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                  <li><i className="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+123 456 7890</span></li>
                  <li><i className="bi bi-chevron-right"></i> <strong>City:</strong> <span>Busan , Republic of Korea</span></li>
                </ul>
              </div>
              <div className="col-lg-6">
                <ul>
                  ...
                  <li><i className="bi bi-chevron-right"></i> <strong>PhEmailone:</strong> <span>dobear7@naver.com</span></li>
        ...
        <div className="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap">
              <img src="assets/img/pusan.jpg" className="img-fluid" alt=""/>
